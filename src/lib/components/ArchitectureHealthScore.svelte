...
<div class="flex items-center justify-between">
    <div class="flex-1">
        <div class="text-6xl font-bold mb-2" style="color: {getHealthColor(overallHealthScore)}">
            {overallHealthScore}
        </div>
        <div class="text-xl font-semibold text-primary-800 mb-4">
